...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        sendTaskInfoToController("A", "A, B, C czy D?", loader);  // wysyłamy info o zadaniu do kontrolera danego pliku
                                                                                                // correctAnswer i questionContent będą wczytywane z pliku
        stage.setScene(mainScreen);
        stage.show();
    }

    private void sendTaskInfoToController(String correctAnswer, String questionContent, FXMLLoader loader) // wysyła dane o zadaniu do kontrolera
    {
